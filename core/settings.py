...
PROJET_APPS = ['apps.user', 'apps.user_profile']
...
INSTALLED_APPS = DJANGO_APPS + PROJET_APPS + ECOMMERCE_APPS + THIRD_PARTY_APPS
...
CORS_ORIGIN_WHITELIST = [
    ...
    'http://127.0.0.1:8000',
    'http://127.0.0.1:3000',
    'http://shop.giovaborgogno.com',
    'https://shop.giovaborgogno.com'
]
